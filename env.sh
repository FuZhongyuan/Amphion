...
pip install tensorboard tensorboardX torch==2.4.0 torchaudio==2.4.0 torchvision==0.19.0 accelerate==0.24.1 transformers==4.41.2 diffusers praat-parselmouth audiomentations pedalboard ffmpeg-python==0.2.0 pyworld diffsptk==1.0.1 nnAudio unidecode inflect ptwt
