...
exp_config="$exp_dir/acoustic_codec.json"
exp_name="maskgct_acoustic_codec"

# Check if checkpoint exists for resume training
# For full models, check if maskgct directory has training checkpoints
checkpoint_dir="${work_dir}/ckpts/maskgct/${exp_name}/checkpoint"
resume_args=""
...
CUDA_VISIBLE_DEVICES="0" accelerate launch --main_process_port 16353 --mixed_precision="bf16" \
