...
exp_config="$exp_dir/acoustic_codec_mini.json"
exp_name="acoustic_codec_mini"
...
CUDA_VISIBLE_DEVICES="4,5" accelerate launch --main_process_port 16353 --mixed_precision="bf16" \
