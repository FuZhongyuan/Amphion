...
exp_config="$exp_dir/s2mel_fm_mini.json"
exp_name="s2mel_fm_mini_ljspeech"
...
####### Train Model ###########
CUDA_VISIBLE_DEVICES="4,5,6,7" accelerate launch --main_process_port 15293 --mixed_precision="bf16" \
