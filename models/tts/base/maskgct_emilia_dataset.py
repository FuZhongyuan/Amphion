...
# class MaskgctEmiliaDataset(EmiliaDataset):
#     def __init__(self, cfg, is_valid=False):
#         super(MaskgctEmiliaDataset, self).__init__(cfg=cfg, is_valid=is_valid)
...
# class MaskgctCollator:
#     def __init__(self, cfg):
#         self.cfg = cfg

#     def __call__(self, batch):
#         """
#         MaskgctEmiliaDataset.__getitem__:
#             wav: (T,)
#             wav_len: int
#             mask: (n_frames,)
