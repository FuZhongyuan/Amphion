...
# Configuration
CFG_PATH="models/tts/maskgct/s2mel_dit_inference.json"
...
S2MEL_CKPT="ckpts/maskgct_mini/s2mel_dit_mini_ljspeech/checkpoint/epoch-0276_step-0036000_loss-0.129780"
...
# Output
mkdir -p "ckpts/maskgct_mini/s2mel_dit_mini_ljspeech/outputs"
OUTPUT_PATH="ckpts/maskgct_mini/s2mel_dit_mini_ljspeech/outputs/output_s2mel_dit.wav"

python models/tts/maskgct/s2mel_dit_inference.py \
    --cfg_path ${CFG_PATH} \
