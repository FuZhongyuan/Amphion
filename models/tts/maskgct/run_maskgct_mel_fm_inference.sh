...
S2MEL_CKPT="ckpts/maskgct_mini/s2mel_fm_mini_ljspeech/checkpoint/epoch-0276_step-0036000_loss-0.580204"
...
# Output
mkdir -p "ckpts/maskgct_mini/s2mel_fm_mini_ljspeech/outputs"
OUTPUT_PATH="ckpts/maskgct_mini/s2mel_fm_mini_ljspeech/outputs/output_s2mel_fm.wav"
